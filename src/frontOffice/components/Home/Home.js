...
import ListMeilleurBien from './listMeilleurBien';
import ListeBienRecomande from './listeBienRecomande';
import ListeClientsSatisfaits from './listeClientsSatisfait';
          ...
          <div id="rev_slider" className="rev_slider" data-version={5.0}>
            <ul>
                ...
                <div className="slider-caption tp-caption tp-resizeme" data-x="['left','left','center','center']" data-hoffset="['0','0','0','15']" data-y="['center','center','center','center']" data-voffset="['0','0','0','0']" data-responsive_offset="on" data-visibility="['on','on','off','off']" data-start={1300} data-transition="fade" data-transform_idle="o:1;" data-transform_in="x:[-100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;s:1500;e:Power3.easeInOut;" data-transform_out="s:1000;e:Power3.easeInOut;s:1000;e:Power3.easeInOut;" data-mask_in="x:0px;y:0px;s:inherit;e:inherit;">
                  ...
                  <div className="bg_white text-left">
                    ...
                    <a href="javascript:void(0)" className="btn-more">
                      <i><img src={require("../../images/arrowl.png")}
                       alt="arrow" /></i>
                      <span>More Details</span>
                      <i><img src={require("../../images/arrowr.png")} 
                      alt="arrow" /></i>
                    </a>
                  </div>
              ...
              <li data-transition="slideleft">
                ...
                <div className="slider-caption tp-caption tp-resizeme"
                 data-x="['right','right','center','center']" data-hoffset="['0','0','0','15']" data-y="['center','center','center','center']" data-voffset="['0','0','0','0']" data-responsive_offset="on" data-visibility="['on','on','off','off']" data-start={1300} data-transform_idle="o:1;" data-transform_in="x:[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;s:1500;e:Power3.easeInOut;" data-transform_out="s:1000;e:Power3.easeInOut;s:1000;e:Power3.easeInOut;" data-mask_in="x:0px;y:0px;s:inherit;e:inherit;">
                  ...
                  <div className="bg_white text-left">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam <br />power nonummy nibh...</p>
                    <a href="javascript:void(0)" className="btn-more">
                      <i><img src={require("../../images/arrowl.png")} alt="arrow" /></i>
                      <span>More Details</span>
                      <i><img src={require("../../images/arrowr.png")} alt="arrow" /></i>
                    </a>
                  </div>
                  <div className="property_meta">
                    <span><i className="icon-select-an-objecto-tool" />4800 sq ft</span>
              ...
              <li data-index="rs-106" data-transition="fade" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-rotate={0} data-param1="HTML5 Video" data-description>
                <img src={require("../../video/thumb.jpg")}alt="video slide" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" className="rev-slidebg" />
              ...
              <li data-transition="slideleft">
                <img src={require("../../images/banner3.jpg")} data-bgposition="center center" data-bgfit="cover" />
              ...
              <div className="col-sm-6">
                <div className="testinomial_wrap heading_space clearfix">
                  <div className="testinomial_text border_radius text-center bottom30">
                    ...
                    <i><img src={require("../../images/quote-left.png")} /></i>
                  </div>
                  <div className="col-xs-12 customer">
                    <img src={require("../../images/author.png")} alt="happy client" />
                    <h4> SAM NICHOLSON</h4>
                    <span>( NorthMarq Capital )</span>
                    <img src={require("../../images/stars.png")} alt="rating" className="rating pull-xs-right" />
                  </div>
                </div>
              </div>
              <div className="col-sm-6">
          ...
          <div className="container partners padding_top">
            ...
            <div className="row">
              <div id="partner-slider" className="owl-carousel">
                <div className="item">
                  <img src={require("../../images/logo1.png")} alt="Featured Partner" />
                </div>
                <div className="item">
                  <img src={require("../../images/logo2.png")} alt="Featured Partner" />
                </div>
                <div className="item">
                  <img src={require("../../images/logo3.png")} alt="Featured Partner" />
                </div>
                <div className="item">
                  <img src={require("../../images/logo4.png")} alt="Featured Partner" />
                </div>
                <div className="item">
                  <img src={require("../../images/logo5.png")} alt="Featured Partner" />
                </div>
                <div className="item">
                  <img src={require("../../images/logo1.png")} alt="Featured Partner" />
                </div>
