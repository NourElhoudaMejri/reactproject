          ...
          <div className="row page-titles">
            <div className="col-md-5 align-self-center">
              ...
              <ol className="breadcrumb">
                <li className="breadcrumb-item"><a href="javascript:void(0)">Acceuil</a></li>
            ...
            <div className="col-md-7 align-self-center text-right d-none d-md-block">
              <button type="button" className="btn btn-info">< a href ="/ajouterAnnonce"i className="fa fa-plus-circle" /> Ajouter  Une Annonce</button>
            </div>
            <div className>
